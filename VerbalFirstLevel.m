...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ImagePathTemplate = '[Exp]/[Subject]/func/verbal/[Run]/';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
SubjDir = {
% 'abs13end00001_00568', [1 2 3 4];
% % 'abs13end00002_00565', [NA NA NA NA];
% 'abs13end00053_04228', [1 2 3 4];
% 'abs13end00056_04375', [1 2 3 4];
% 'abs13end00246_04277', [1 2 3 4];
% 'abs13ins00003_01346', [1 2 3 4];
% 'abs13ins00004_01411', [1 2 3 4];
% 'abs13ins00005_01533', [1 2 3 4];
% 'abs13ins00006_01591', [1 2 3 4];
% 'abs13ins00007_01590', [1 2 3 4];
% 'abs13ins00008_01659', [1 2 3 4];
% 'abs13ins00009_01770', [1 2 3 4];
% 'abs13ins00010_01687', [1 2 3 4];
% 'abs13ins00011_01690', [1 2 3 4];
% 'abs13ins00013_01841', [1 2 3 4];
% 'abs13ins00014_02465', [1 2 3 4];
% 'abs13ins00015_02327', [1 2 3 4];
% % 'abs13ins00016_02304', [1 2 NA NA]; % missing t1spgr
% 'abs13ins00017_02371', [1 2 3 4];
% 'abs13ins00020_02581', [1 2 3 4];
% 'abs13ins00021_02495', [1 2 3 4];
% 'abs13ins00024_03288', [1 2 3 4];
% 'abs13ins00025_02644', [1 2 3 4];
% 'abs13ins00026_02659', [1 2 3 4];
% 'abs13ins00028_02674', [1 2 3 4];
% 'abs13ins00035_03073', [1 2 3 4];
% 'abs13ins00036_02976', [1 2 3 4];
% 'abs13ins00037_02988', [1 2 3 4];
% 'abs13ins00038_03123', [1 2 3 4];
% 'abs13ins00039_03046', [1 2 3 4];
% 'abs13ins00040_03279', [1 2 3 4];
% 'abs13ins00042_03392', [1 2 3 4];
% 'abs13ins00046_03742', [1 2 3 4];
% 'abs13ins00049_03933', [1 2 3 4];
% 'abs13ins20017_03308', [1 2 3 4];
'abs13ins20024_04204', [1 2 3 4];
% 'abs13ins20036_03982', [1 2 3 4];
% 'abs13ins20042_04134', [1 2 3 4];
};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MasterDataFilePath = '/nfs/turbo/berent-lab/metabolic/Endopoid/endoeprime/MasterDataFiles/MDF_Verbal.csv';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
RegFilesTemplate = {
    '[Exp]/[Subject]/func/verbal/[Run]/realign.txt',Inf,0,1;
    '/nfs/turbo/berent-lab/Researchers/heffjos/BadVolumeComparison/[Subject]/func/verbal/[Run]/CensorVectors.csv', Inf, 0, 1;
};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputDir = fullfile(pwd, './FL_CensorOnly/[Subject]/Verbal');
...
%%% ExplicitMask = '';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ExplicitMask = '/nfs/turbo/berent-lab/metabolic/Endopoid/Data/[Subject]/func/verbal/VerbalMask.nii';
